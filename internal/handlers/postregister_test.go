...
import (
	...
	storemock "github.com/blacktau/priyome/internal/store/mock"
...
func TestRegisterUserHandler(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			handler := NewPostRegisterHandler(userStore)
			...
			assert.Equal(tc.expectedStatusCode, rr.Code, "handler returned wrong status code: got %v expected %v", rr.Code, tc.expectedStatusCode)
